...
#define first_durations_address_in_multi_mode (first_current_address_in_multi_mode+max_no_of_members)
#define	current_address(x)  (first_current_address_in_multi_mode+x)//starting from x =0 not 1
#define	duration_address(x)  (first_durations_address_in_multi_mode+x)//starting from x =0 not 1
#define first_time_consumed_address_in_multi_mode (first_durations_address_in_multi_mode+max_no_of_members)
#define	time_consumed_address(x)  (first_time_consumed_address_in_multi_mode+x)	 
#define	pointer_to_the_running_process_address(x)  (first_pointer_to_the_running_process_address+x)		 
...
extern uint8_t mode;
	 extern uint8_t START_FINE_TUNE_OPERATION_IN_AUTO_MODE;
