...
#define _50_micro_timer                            TIM2  
#define hal_50_micro_timer                         htim2
...
#define use_flash_memory                           without
#define adc_def                                    hadc                            
#define _50_micro_timer                            TIM3
#define hal_50_micro_timer                         htim3	 
#define hal_measurement_timer                      hal_50_micro_timer                	 
...
#define use_flash_memory                           without
#define adc_def                                    hadc
#define _50_micro_timer                            TIM1
#define hal_50_micro_timer                         htim1 
#define hal_measurement_timer                      hal_50_micro_timer
#define hal_firing_timer                           htim3
