...
#define hmi_first_time_consumed_address_in_multi_mode         0xDD   
#define hmi_last_time_consumed_address_in_multi_mode          0x100  
...
#define hmi_first_pointer_to_the_running_process_address 			0x95
#define hmi_last_pointer_to_the_running_process_address  			0xB8
...
#define sd_card_first_pointer_to_the_running_process_address 	0xD7
#define sd_card_last_pointer_to_the_running_process_address  	0xDC

#define hmi_first_capacity_address_in_multi_mode         			0xDD  
#define hmi_last_capaciyy_address_in_multi_mode            		0x100	 

#define insert_data_from_sd_card_in_auto_mode_ADDRESS					0X101
#define insert_data_using_hmi_screen_in_auto_mode_ADDRESS			0X102

#define sd_card_USER_PROCESS_BEGINING_ADDRESS									0X103
