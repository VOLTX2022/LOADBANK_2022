...
//	AVERAGE_ADC_IN_REEL_UNIT[ampere_fixed_steps]=currents_summator;	 
	...
	AVERAGE_ADC_IN_REEL_UNIT[ampere_fixed_steps]=auto_calibration(no_of_calibration_values_ch1,calibration_array_in_ampere,calibration_adc_array_current,AVERAGE_ADC[ampere_fixed_steps]);
...
else
{
	...
	total_measured_ampere=	currents_summator;
		...
		total_measured_ampere=	auto_calibration(  no_of_calibration_values_ch1 , calibration_array_in_ampere,calibration_adc_array_current,AVERAGE_ADC[ampere_fixed_steps]); 
